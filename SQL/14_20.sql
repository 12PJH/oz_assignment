...
insert into employees(name,position, salary) values -- employees 테이블에 입력한 데이터 생성
('혜린', 'PM', '90000'),('은우', 'Frontend', '80000'),('가을', 'Backend', '92000'),
('지수', 'Frontend', '78000'),('민혁', 'Frontend', '96000'),('하온', 'Backend', '130000');
